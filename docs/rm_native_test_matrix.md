...
| Strict left-to-right AND/OR/XOR with early stop | TBD | `expr_precedence.json` | | ❌ | Round-trip must preserve operator order; a decided left side skips later terms |
